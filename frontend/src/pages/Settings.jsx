          ...
          <div className="settings-section">
            ...
            <div className="api-key-security">
              ...
              <span className="security-note">
                Your API key is encrypted and stored securely in Clerk's private metadata. 
                <a href="https://clerk.com/docs/guides/users/extending#private-metadata" target="_blank" rel="noopener">Learn more</a>
              </span>
            </div>
          </div>
        )}
